...
Runs all 30 CEC2017 functions at dimension 2.

Usage:
    python -m CEC2017.run_all_d2
"""
...
def _prompt_algorithm():
    ...
    while True:
        print("=" * 60)
        print("  CEC2017 — Run All Functions (D=2 ONLY)")
        print("=" * 60)
...
def main():
    """Run all 30 CEC2017 functions at D=2 only."""
