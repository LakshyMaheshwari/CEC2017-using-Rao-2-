...
Runs all 28 CEC2013 functions at dimension 10.

Usage:
    python -m CEC2013.run_all_d10
"""
...
def _prompt_algorithm():
    ...
    while True:
        print("=" * 60)
        print("  CEC2013 — Run All Functions (D=10 ONLY)")
        print("=" * 60)
...
def main():
    """Run all 28 CEC2013 functions at D=10 only."""
