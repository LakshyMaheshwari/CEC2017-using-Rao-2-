"""
Automated benchmark runner — runs all 28 CEC2013 functions
across all configured dimensions for one or more algorithms.

Usage:
    python -m CEC2013.run_all
"""
...
def _prompt_algorithm():
    ...
    while True:
        print("=" * 60)
        print("  CEC2013 — Run All Functions")
        print("=" * 60)
...
def main():
    """
    Automated script to run all 28 CEC2013 functions
