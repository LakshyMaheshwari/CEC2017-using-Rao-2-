"""
Automated benchmark runner — D=2 ONLY.
Runs all 28 CEC2013 functions at dimension 2.

Usage:
    python -m CEC2013.run_all_d2
"""
...
def _prompt_algorithm():
    ...
    while True:
        print("=" * 60)
        print("  CEC2013 — Run All Functions (D=2 ONLY)")
        print("=" * 60)
...
def main():
    """Run all 28 CEC2013 functions at D=2 only."""
    algo_names = _prompt_algorithm()

    dim = 2  # Fixed dimension
