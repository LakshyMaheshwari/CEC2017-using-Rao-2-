...
Usage:
    python -m CEC2013.collect_results
    python -m CEC2013.collect_results --algo rao2
    python -m CEC2013.collect_results --algo rao2 --dim 10
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Collect CEC2013 benchmark results into CSV files."
    )
